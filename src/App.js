...
const SOCKET_SERVER_URL =
  process.env.REACT_APP_SOCKET_SERVER_URL || "wss://api.kaspa.org";
const REST_API_SERVER_URL =
  process.env.REACT_APP_REST_API_SERVER_URL || "https://api.kaspa.org";
              ...
              <Container id="navbar-container" fluid>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                  ...
                  <div className="ms-auto navbar-price">
                    {/* ${price} <span>/ RAS</span> */}${price}{" "}
                    <span className="text-light">/ RAS</span>
                  </div>
                </Navbar.Collapse>
              </Container>
            </Navbar>
                    ...
                    <Form onSubmit={search} className="">
                      <InputGroup className="mt-4 mb-4 search-box-group">
                        <Form.Control
                          ...
                          id="search-box-high"
                          type="text"
                          placeholder="Search for raspa:address or block"
                        />
                        <Button
                          type="submit"
              ...
              <Row className="d-none d-sm-block">
                <Col>
                  ...
                  <span className="ms-3">
                    ...
                    >
                      <a
                        ...
                        href="https://github.com/LoopNetworkRaspa/raspa-explorer-fork/tree/dev"
                        target="_blank"
                      >
                    ...
                    >
                      <Link
                        ...
                        to="/addresses/raspadev:qqu724a52f77xuyvua7csu37pf3rlm6stmssqtnxvjw56r5g67r2cqhvsgmut"
                      >
                    ...
                    >
                      <a
                        className="blockinfo-link ms-3"
                        href="https://rest.raspadev.blaize.technology/"
                        target="_blank"
                      >
                  ...
                  <span className="build">
                    Build version: {BUILD_VERSION.substring(0, 8)}
                  </span>
                </Col>
              </Row>
