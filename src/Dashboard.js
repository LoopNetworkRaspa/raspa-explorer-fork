        ...
        <div>
            ...
            <div className="row1 p-4 p-sm-5">
                <Container className="firstRow webpage" fluid>
                    <Row>
                        <Col md={12}
                             className='d-flex flex-row justify-content-start align-items-center text-light d-xs-none align-items-center'
                             style={{height: '200px'}}>
                            ...
                            <Form onSubmit={search}>
                                <InputGroup className="ms-md-5 mt-5 me-5 dashboard-search-box">
                                    <Form.Control className="bg-light text-dark shadow-none" name="searchInput"
                                                  type="text" placeholder="Search for raspa:address or block"/>
